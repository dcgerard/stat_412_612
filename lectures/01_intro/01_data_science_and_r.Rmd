...
- Week 1: Intro (chapters 1--2), install R, Rmarkdown (chapter 27), R basics (chapters 4).
- Week 2: R Programming (Chapters 17--21)
- Week 3: Data Visualization (chapter 3)
- Week 4: Manipulating Data Frames with dplyr (chapter 5), R scripts (chapter 6)
- Week 5: Exam 1, dplyr (chapter 5)
- Week 6: dplyr lab (chapter 5)
- Week 7: sploratory data analysis: (chapters 7--11)
- Week 8: tidyr (chapter 12)
- Week 9: tidyr lab (chapter 12)
- Week 10: Exam 2
- Week 11: Relational Data (chapter 13)
- Week 12: Strings (Chapter 14)
- Week 13: Either factors or dates or git
...
- The exams will be in-class coding assignments. You will have 1.5 hours to
