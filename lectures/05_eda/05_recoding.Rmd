...
- But all of those individuals are 
  [droids](https://en.wikipedia.org/wiki/Droid_(Star_Wars)), so it 
  would be reasonable to replace all of the `NA`s in `gender` with `"droid"`.
