...
- [Data Transformation Cheatsheet](https://www.rstudio.com/resources/cheatsheets/#dplyr).
...
- **Exercise** ([RDS](https://r4ds.had.co.nz/) 13.3.1.2): Identify the keys in the following datasets
...
- A join connects one row of `x` to one row of `y`
